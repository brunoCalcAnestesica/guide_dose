...
class CardMedicamentoDinamico extends StatefulWidget {
  ...
  @override
  State<CardMedicamentoDinamico> createState() =>
      _CardMedicamentoDinamicoState();
}
...
class _CardMedicamentoDinamicoState extends State<CardMedicamentoDinamico> {
  ...
  Widget build(BuildContext context) {
    ...
    final diluicoesInfusao = _todasDiluicoesInfusao();
    final textoDiluicaoInfusao =
        diluicoesInfusao[diluicaoInfusaoSelecionada] ?? '';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Builder(
              builder: (_) {
                final Map<String, dynamic> preparo =
                    (widget.medicamento['preparo'] ?? {})
                        .cast<String, dynamic>();
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('${e['dose']} ${e['unidade']}',
                              style: const TextStyle(
                                  fontSize: 13, fontWeight: FontWeight.w500)),
                          if (e['via'] != null)
                            Text('Via: ${_formatarVia(e['via'])}',
                                style: const TextStyle(
            ...
            DropdownButton<String>(
              ...
              isExpanded: true,
              onChanged: (val) =>
                  setState(() => diluicaoInfusaoSelecionada = val),
              items:
                  diluicoesInfusao.entries.map<DropdownMenuItem<String>>((e) {
            ...
            Row(
              ...
              children: [
                Text('${doseSelecionada.toStringAsFixed(2)} $unidadePadrao',
                    style: const TextStyle(fontSize: 13)),
  ...
  double? _extrairConcentracao(String texto) {
    final regex =
        RegExp(r'(\d+(\.\d+)?)\s*mcg\s*/?\s*mL', caseSensitive: false);
  ...
  double _calcularMlH(
      double dose, double peso, String unidade, double? concentracao) {
